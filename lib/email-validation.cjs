...
const STRICTLY_PLACEHOLDER_LOCAL_RE = /^(?:someone|anybody|nobody|somebody|placeholder|fake|dummy|notarealperson|jane\.doe|john\.doe|firstname\.lastname|first\.last|first\.name|your\.name|your\.email|first|last|ericjonesmyemail|eric\.jones\.myemail)$/i;
