// step-2-email-scraper-test4.cjs
...
const OUTPUT_CSV = path.join(__dirname, 'output', 'Step 2', `step-2-email-scraper-test4-output-${Date.now()}.csv`);

// Base paths to try without suffixes
const basePaths = [
  '',
  '/contact',
  '/contact-us',
...
// Generate all variants with .html and .php suffixes
const pathsToTry = [];
