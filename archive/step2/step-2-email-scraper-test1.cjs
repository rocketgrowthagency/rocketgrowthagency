// step-2-email-scraper-test1.cjs
...
const INPUT_CSV = path.join(__dirname, 'output', 'Step 1', '2025-08-05-Dentists-los-angeles-[step-1]-all.csv');

const OUTPUT_CSV = path.join(
  __dirname,
  'output',
  'Step 2',
  `step-2-email-scraper-test1-output-${Date.now()}.csv`
);
