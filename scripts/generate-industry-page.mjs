...
const STYLE = `  <style id="promo-bar-style">
  ...
  <style id="ix-redesign">
    ...
    .ix-hero-in{position:relative;padding:5rem max(1.75rem,calc((100vw - var(--max-width))/2)) 3.6rem;display:grid;grid-template-columns:1.05fr .95fr;gap:3rem;align-items:start}
...
<head>
  ...
  <style id="ih-hero">
    ...
    .ih-in{position:relative;padding:5rem max(1.75rem,calc((100vw - var(--max-width))/2)) 3.8rem;display:grid;grid-template-columns:1.02fr .98fr;gap:3rem;align-items:start}
